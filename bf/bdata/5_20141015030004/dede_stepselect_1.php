...
E_D("replace into `dede_stepselect` values('13','行业','vocation','0','0');");
E_D("replace into `dede_stepselect` values('14','地区','nativeplace','0','0');");
E_D("replace into `dede_stepselect` values('15','信息类型','infotype','0','0');");

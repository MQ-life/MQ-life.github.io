...
E_D("replace into `dede_sysconfig` values('1','cfg_basehost','站点根网址','1','string','http://127.0.0.5');");
E_D("replace into `dede_sysconfig` values('2','cfg_cmspath','DedeCMS安装目录','2','string','');");
E_D("replace into `dede_sysconfig` values('3','cfg_cookie_encode','cookie加密码','2','string','VuTBt8977T');");
...
E_D("replace into `dede_sysconfig` values('7','cfg_webname','网站名称','1','string','正邦装修');");
...
E_D("replace into `dede_sysconfig` values('10','cfg_arcdir','文档HTML默认保存路径','1','string','/a');");
...
E_D("replace into `dede_sysconfig` values('24','cfg_df_style','模板默认风格','1','string','moban');");
...
E_D("replace into `dede_sysconfig` values('28','cfg_powerby','网站版权信息','1','bstring','Copyright &copy; 2013-2014 正邦网络 版权所有');");
...
E_D("replace into `dede_sysconfig` values('719','cfg_makeindex','发布文章后马上更新网站主页','6','bool','Y');");
...
E_D("replace into `dede_sysconfig` values('59','cfg_arc_dellink','删除非站内链接','7','bool','Y');");
...
E_D("replace into `dede_sysconfig` values('62','cfg_title_maxlen','文档标题最大长度<br>改此参数后需要手工修改数据表','7','number','200');");
...
E_D("replace into `dede_sysconfig` values('68','cfg_album_style','图集默认样式<br />1为多页多图,2为多页单图,3为缩略图列表','3','number','3');");
...
E_D("replace into `dede_sysconfig` values('728','cfg_mb_allowreg','是否允许新会员注册','4','bool','N');");
...
E_D("replace into `dede_sysconfig` values('710','cfg_keywords','站点默认关键字','1','string','');");
E_D("replace into `dede_sysconfig` values('711','cfg_description','站点描述','1','bstring','');");
E_D("replace into `dede_sysconfig` values('712','cfg_beian','网站备案号','1','string','京XXXX123456789');");
...
E_D("replace into `dede_sysconfig` values('719','cfg_make_andcat','发表文章后马上更新相关栏目','6','bool','Y');");
...
E_D("replace into `dede_sysconfig` values('727','cfg_mb_allowncarc','是否允许用户空间显示未审核文章','4','bool','N');");
...
E_D("replace into `dede_sysconfig` values('0','cfg_disable_funs','模板引擎禁用PHP函数','7','bstring','phpinfo,eval,exec,passthru,shell_exec,system,proc_open,popen,curl_exec,curl_multi_exec,parse_ini_file,show_source,file_put_contents');");
E_D("replace into `dede_sysconfig` values('0','cfg_disable_tags','模板引擎禁用标签','7','bstring','php');");
